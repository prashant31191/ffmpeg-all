...
public class TrimAudioVideo extends Activity implements View.OnClickListener {

    private static final String TAG = TrimAudioVideo.class.getSimpleName();
...
*/
    ...
    private void setAddAudioDone()
    {
        ...
        if (command.length != 0) {
            ...
            Toast.makeText(TrimAudioVideo.this, getString(R.string.empty_command_toast), Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void addTextViewToLayout(String text) {
        TextView textView = new TextView(TrimAudioVideo.this);
        textView.setText(text);
        outputLayout.addView(textView);
    }

    private void showUnsupportedExceptionDialog() {
        new AlertDialog.Builder(TrimAudioVideo.this)
